...
\end{titlepage}
	...
	Das Punktesystem basiert auf den versenkten Kugeln. Jeder versenkte Ball der eigenen Gruppe bringt einen Punkt. Die schwarze Kugel bringt zusätzlich 8 Punkte, wenn sie korrekt versenkt wird. Das Spiel endet, wenn ein Spieler alle Kugeln seiner Gruppe versenkt hat und die 8-Ball korrekt eingelocht wird. Der Spieler mit den meisten Punkten gewinnt das Spiel.
...
Sobald die gewünschte Stärke erreicht ist, wird die Maustaste losgelassen, und der Schuss wird ausgeführt. Dieser Vorgang wird wiederholt, bis das Spiel gewonnen ist.

Im Falle eines Fouls (wenn die weiße Kugel in eine Tasche fällt) darf der nächste Spieler die Kugel an einer beliebigen Stelle auf dem Tisch platzieren.
...
\newpage
	...
	\caption{Kollision der zwei Kugeln}
\end{figure}
...
\end{equation}	
	...
	Diese Werte werden zu Beginn festgelegt, für die Instanziierung des Tisches verwendet und können global in der Ball Klasse genutzt werden.  
...
Die Texturierung ist ein relativ einfacher, jedoch sehr wichtiger Vorgang, der den visuellen Eindruck und somit den Spielfaktor erheblich steigern kann. In unserer Implementierung haben wir verschiedene Objekte texturiert, um ein realistisches Erscheinungsbild zu gewährleisten.

Im Folgenden sind die verwendeten Texturen dargestellt:
